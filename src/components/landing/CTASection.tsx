    ...
    <section className="py-24 px-6 relative overflow-hidden" id="tarifs">
      ...
      <div className="max-w-4xl mx-auto flex flex-col gap-6">
        ...
        <div className="glass-card p-10 text-center relative overflow-hidden">
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", width: 48, height: 48, borderRadius: "0.75rem", background: "rgba(245,158,11,0.12)", border: "1px solid rgba(245,158,11,0.25)", color: "#f59e0b", margin: "0 auto 0.75rem" }}><ChefHat size={22} /></div>
          <h2
        ...
        >
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", width: 48, height: 48, borderRadius: "0.75rem", background: "rgba(245,158,11,0.12)", border: "1px solid rgba(245,158,11,0.25)", color: "#f59e0b", margin: "0 auto 0.75rem" }}><Truck size={22} /></div>
          <h2
